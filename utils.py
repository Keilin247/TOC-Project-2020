...
def send_gif(reply_token):
    line_bot_api = LineBotApi(channel_access_token)
    message =   VideoSendMessage(original_content_url='https://ezgif.com/gif-to-mp4?url=https://i.pinimg.com/originals/cd/6e/96/cd6e965e0a5769560a5c88d471fe0cb1.gif',preview_image_url='https://i.pinimg.com/originals/cd/6e/96/cd6e965e0a5769560a5c88d471fe0cb1.gif'))
    line_bot_api.push_message("U46b5bdcccc8124e05d79148943af39e5", message)
